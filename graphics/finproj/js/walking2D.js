...
description = `
<b>Meet the Skeletons!</b>
<p>
<b>Femur</b> and <b>Tibia</b>! <br>
Select your two figures and their dance modes here, and then follow the choreography instructions!
<br>
<img src=imgs/femur.png width=100> <img src=imgs/tibia.png width=100>
<br>
<form>
  <label for="c1_name"><u>Choose Character One:</u></label>
  <select name="c1_name" id="c1_name">
    <option value="F">Femur</option>
    <option value="T">Tibia</option>
  </select>
</form>
<form>
  <label for="c1_mode">Character One Dance Skill:</label>
  <select name="c1_mode" id="c1_mode">
    <option value="P" selected>Pro</option>
    <option value="C">Chicken</option>
  </select>
  <br>
</form>
<form>
  <label for="c2_name"><u>Choose Character Two:</u></label>
  <select name="c2_name" id="c2_name">
    <option value="F">Femur</option>
    <option value="T" selected>Tibia</option>
  </select>
</form>
<form>
  <label for="c1_mode">Character One Dance Skill:</label>
  <select name="c2_mode" id="c2_mode">
...
<br>
<b><i>Choreography Instructions:</i></b>
<ol>
...
//THIS RESAMPLE ALLOWS FOR CONSTANT WALK SPEED REGARDLESS OF SEGMENT LENGTH!
  ...
  if (S.isWalk) {
	...
	for (let f = 0 ; f < 2 ; f++) {
     ...
     let dsi = Math.floor(ds);  //integer component
     let dsf = ds - dsi;        //floating component
     for (let f = 0 ; f < 2 ; f++)
    ...
    S.profiles    = [c1_prof, c2_prof];
    S.danceModes  = [c1_dmode, c2_dmode];
`,
events: `
  let K = S.K;
